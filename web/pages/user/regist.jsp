...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			$(function () {
				...
				// 用ajax和json实现判断用户名已存在
				$("#username").blur(function (){
					var username = $(this).val();
					$.getJSON(
							"userServlet?action=ajaxExistsUsername",
							{"username":username},
							function (data) {
	...
	<body>
		<div id="login_header">
			...
			<span class="wel_word">快抢注一个好听的名字</span>
		</div>
						...
						<div class="login_box">
							...
							<div class="form">
								<form  action="userServlet" method="post">
									...
									<img id="code_img" alt="" src="kaptcha.jpg" style="float: right; width: 115px;height: 38px">
									<br />
									<br />
